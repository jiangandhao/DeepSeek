    ...
    <div class="auth-shell">
      ...
      <aside class="auth-aside">
        ...
        <div class="aside-copy">
          <h2>欢迎回来 👋</h2>
          <p>登录后即可查看你的健康监测、每日方案与 AI 健康助手。</p>
        </div>
      ...
      <section class="auth-card">
        <div class="card-head">
          ...
          <p class="subtitle">使用用户名和密码登录知愈健康</p>
        </div>
        <el-form :model="form" @submit.prevent>
          <el-form-item>
            <el-input v-model="form.username" size="large" placeholder="用户名" :prefix-icon="User" @keyup.enter="onLogin" />
          </el-form-item>
          <el-form-item>
            <el-input v-model="form.password" size="large" type="password" placeholder="密码" :prefix-icon="Lock" show-password @keyup.enter="onLogin" />
          </el-form-item>
          <el-button type="primary" size="large" :loading="loading" style="width: 100%" @click="onLogin">登录</el-button>
        </el-form>
...
import { FirstAidKit, User, Lock, TrendCharts, Calendar, ChatDotRound } from '@element-plus/icons-vue'
